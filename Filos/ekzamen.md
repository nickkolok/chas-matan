...
Именно научное сообщество выбирает парадигму - фундаментальную теорию, которая даёт общее видение мира, образцы постаановки и решения исследовательских задач.
...
Та исследовательская программа, которая лучше предсказывает внось открываемые явления, побеждает.
